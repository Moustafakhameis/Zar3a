            ...
            <ul className="space-y-6 relative z-10">
              {traditional.map((item, idx) => (
                <motion.li 
                  ...
                  className="flex items-center gap-4 text-lg font-bold text-slate-500 dark:text-slate-400 cursor-default"
                >
                  <motion.div 
                    whileHover={{ 
                      rotate: 90, 
                    ...
                    className="w-8 h-8 rounded-full bg-red-500/10 dark:bg-red-500/10 flex items-center justify-center text-red-500 flex-shrink-0"
                  >
            ...
            <ul className="space-y-6 relative z-10">
              {zar3a.map((item, idx) => (
                <motion.li 
                  ...
                  className="flex items-center gap-4 text-lg font-black text-emerald-700 dark:text-emerald-300 cursor-default"
                >
                  <motion.div 
                    animate={{ 
                      boxShadow: ["0px 0px 0px 0px rgba(16,185,129,0.6)", "0px 0px 0px 10px rgba(16,185,129,0)"],
