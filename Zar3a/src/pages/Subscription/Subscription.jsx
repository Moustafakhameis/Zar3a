      ...
      <div className="max-w-6xl mx-auto space-y-12">
        ...
        >
          <h1 className="text-4xl md:text-5xl font-black text-text-main dark:text-white tracking-tight">
            Choose Your <span className="text-primary-base">Zar3a Plan</span>
          </h1>
          <p className="text-lg text-text-muted dark:text-text-disabled max-w-2xl mx-auto font-medium">
        ...
        >
          {/* Tier 1 */}
          <div className="bg-surface-card dark:bg-slate-900 border border-border-default dark:border-slate-800 rounded-[2.5rem] overflow-hidden flex flex-col shadow-sm hover:shadow-xl transition-all duration-300">
            <div className="p-8 border-b border-border-default dark:border-slate-800">
              ...
              <div className="flex items-baseline gap-1 mb-4">
                <span className="text-4xl font-black text-text-main dark:text-white">500</span>
                <span className="text-sm font-bold text-text-muted dark:text-text-disabled">EGP / month</span>
              </div>
              <p className="text-sm text-text-muted dark:text-text-disabled font-medium leading-relaxed">
            ...
            <div className="p-8 flex-1 flex flex-col bg-slate-50/50 dark:bg-slate-900/50">
              <div className="space-y-6 flex-1">
                <div>
                  <h4 className="text-[10px] font-black tracking-widest uppercase text-text-muted dark:text-text-disabled mb-3">Monitoring</h4>
                ...
                <div>
                  <h4 className="text-[10px] font-black tracking-widest uppercase text-text-muted dark:text-text-disabled mb-3">Marketplace & Consultation</h4>
                  <ul className="space-y-3">
                    <li className="flex items-start gap-3 text-sm font-semibold text-text-main dark:text-slate-200">
                      <LuCheck className="text-emerald-500 mt-0.5 shrink-0" size={18} />
                ...
                <div>
                  <h4 className="text-[10px] font-black tracking-widest uppercase text-text-muted dark:text-text-disabled mb-3">Locked Features</h4>
                  <ul className="space-y-3">
              ...
              <button className="w-full mt-8 py-4 rounded-2xl font-black text-sm bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-300 hover:bg-slate-200 dark:hover:bg-slate-700 transition uppercase tracking-widest">
                Select Starter
              </button>
            </div>
          </div>
          ...
          {/* Tier 2 */}
          <div className="bg-surface-card dark:bg-slate-900 border border-border-default dark:border-slate-800 rounded-[2.5rem] overflow-hidden flex flex-col shadow-sm hover:shadow-xl hover:-translate-y-2 transition-all duration-300 relative">
            <div className="p-8 border-b border-border-default dark:border-slate-800">
              ...
              <div className="flex items-baseline gap-1 mb-4">
                <span className="text-4xl font-black text-text-main dark:text-white">1,000</span>
                <span className="text-sm font-bold text-text-muted dark:text-text-disabled">EGP / month</span>
              </div>
              <p className="text-sm text-text-muted dark:text-text-disabled font-medium leading-relaxed">
            ...
            <div className="p-8 flex-1 flex flex-col bg-slate-50/50 dark:bg-slate-900/50">
              <div className="space-y-6 flex-1">
                <div>
                  <h4 className="text-[10px] font-black tracking-widest uppercase text-text-muted dark:text-text-disabled mb-3">Everything in Starter, plus</h4>
                  <ul className="space-y-3">
                    <li className="flex items-start gap-3 text-sm font-semibold text-text-main dark:text-slate-200">
                      <LuCheck className="text-emerald-500 mt-0.5 shrink-0" size={18} />
                ...
                <div>
                  <h4 className="text-[10px] font-black tracking-widest uppercase text-text-muted dark:text-text-disabled mb-3">Still Locked</h4>
                  <ul className="space-y-3">
                    <li className="flex items-start gap-3 text-sm font-medium text-slate-400 dark:text-slate-600">
                      <LuLock className="mt-0.5 shrink-0" size={16} />
                      <span className="flex-1 line-through decoration-slate-300 dark:decoration-slate-700">AI crop diagnosis</span>
              ...
              <button className="w-full mt-8 py-4 rounded-2xl font-black text-sm bg-emerald-100 dark:bg-emerald-900/30 text-emerald-800 dark:text-emerald-400 hover:bg-emerald-200 dark:hover:bg-emerald-900/50 transition uppercase tracking-widest">
                Select Growth
              </button>
            </div>
          </div>
          ...
          {/* Tier 3 */}
          <div className="bg-surface-card dark:bg-slate-900 border-[3px] border-primary-base rounded-[2.5rem] overflow-hidden flex flex-col shadow-2xl shadow-green-500/10 hover:-translate-y-2 transition-all duration-300 relative scale-[1.02] z-10">
            <div className="absolute top-0 inset-x-0 h-2 bg-gradient-to-r from-emerald-400 to-teal-500"></div>
            
            <div className="p-8 border-b border-border-default dark:border-slate-800 relative">
              <div className="absolute top-8 right-8 text-primary-base dark:text-emerald-400">
              ...
              <div className="flex items-baseline gap-1 mb-4">
                <span className="text-4xl font-black text-primary-base dark:text-emerald-400">2,000</span>
                <span className="text-sm font-bold text-text-muted dark:text-text-disabled">EGP / month</span>
              </div>
              <p className="text-sm text-text-muted dark:text-text-disabled font-medium leading-relaxed">
            ...
            <div className="p-8 flex-1 flex flex-col bg-green-50/30 dark:bg-emerald-950/10">
              <div className="space-y-6 flex-1">
                <div>
                  <h4 className="text-[10px] font-black tracking-widest uppercase text-text-muted dark:text-text-disabled mb-3">Everything in Growth, plus</h4>
                  <ul className="space-y-3">
                    <li className="flex items-start gap-3 text-sm font-semibold text-text-main dark:text-slate-200">
                      <div className="mt-0.5 shrink-0 bg-primary-light dark:bg-emerald-900/50 p-1 rounded-full text-primary-base dark:text-emerald-400">
              ...
              <button className="w-full mt-8 py-4 rounded-2xl font-black text-sm bg-gradient-to-r from-emerald-500 to-teal-500 text-white shadow-xl shadow-emerald-500/20 hover:shadow-2xl hover:shadow-emerald-500/40 hover:-translate-y-0.5 transition-all uppercase tracking-widest">
                Select Pro Plan
              </button>
            </div>
          </div>
