...
import { useAgriShopProductsQuery } from '../../hooks/queries/useMarketplace';
              ...
              >
                ...
                <div className="flex flex-1 flex-col gap-3 p-4">
                  ...
                  <div className="mt-auto flex items-end justify-between">
                    ...
                    <button
                      onClick={() => onAddToCart(product, 'agri')}
...
const AgriShop = () => {
  ...
  const { data: products = [], isLoading: loading } = useAgriShopProductsQuery();
              ...
              >
                ...
                <div className="flex items-start justify-between gap-3 mb-3">
                  <div>
                    ...
                    <p className="text-xs text-text-muted mt-0.5">{product.category || 'Agri supply'}</p>
                    {product.region && (
